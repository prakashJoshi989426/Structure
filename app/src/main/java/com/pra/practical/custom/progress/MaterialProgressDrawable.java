...
public class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    /**
     * Update the background color of the circle_indicator_shape image view.
     */
        ...
        final Animation animation = new Animation() {
            ...
            public void applyTransformation(float interpolatedTime, Transformation t) {
                if (mFinishing) {
                    ...
                    //Avoid the ring to be a full circle_indicator_shape
    ...
    private static class Ring {
        ...
        // progress circle_indicator_shape should currently display. As the progress circle_indicator_shape is
        ...
        /**
         * @param centerRadius Inner radius in px of the circle_indicator_shape the progress
         *                     spinner arc traces.
         */
